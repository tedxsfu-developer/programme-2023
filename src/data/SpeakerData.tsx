export const speakerData = [
  // VLADIMIR KANIC
  {
    ...
    image: ["img/vladimir-headshot.png"],
  ...
  // SUMAIYA TUFAIL
  {
    ...
    href: "sumaiya",
    desc: "Slam Poet",
    image: ["img/sumaiya-headshot.png"],
